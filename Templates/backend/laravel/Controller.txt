...
[[ITERATE(/BaseMethodsNew/crud) --include-files="laravel" --template="    public function {{controllerMethod}}
    {
{{controllerContent}}    }"]]

[[ITERATE(/BaseMethodsNew/advanced-operations) --include-files="laravel" --template="    public function {{controllerMethod}}
    {
{{controllerContent}}    }"]]
}
